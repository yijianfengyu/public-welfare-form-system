...
<iframe id="myframe" name="myframe"  style='width:380px;border:none;' height="3000" src='${url}' allowTransparency='true' scrolling='no' seamless='seamless' frameborder='0' ></iframe>
