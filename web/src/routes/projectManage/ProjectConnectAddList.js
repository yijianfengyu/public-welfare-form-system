...
const ProjectConnectAddList = ({ dispatch,
  projectConnect,
  ...
  function handleOk () {
    projectConnect.state='ok';
    dispatch({
      type: 'projectManage/addProjectTeamPartner', payload: {
        connectId:projectConnect.id,
        projectTeamListSelect,
        addProjectConnectModelShow: false,
      },
    })
...
export default Form.create()(ProjectConnectAddList)
